...
/**
 * The Pricing module provides access to pricing and rates logic for tokens in the honey protocol
 */
export class Pricing extends SDKModule {
    /**
    * returns the best conversion path and rate for a given pair of tokens in the honey protocol
    * 
    ...
    */
    ...
    /**
    * returns the best conversion paths and rates for a given pair of tokens and input amounts in the honey protocol
    * 
    * @param sourceToken    source token
    * @param targetToken    target token
   ...
   async getPathsAndRates(sourceToken: Token, targetToken: Token, amounts: string[] = ['1']): Promise<Array<{path: Token[], rate: string}>> {
    ...
    /**
    * returns the rate for a given conversion path in the honey protocol 
    * 
