...
var Ethereum = /** @class */ (function () {
    ...
    Ethereum.create = function (nodeEndpoint) {
        return __awaiter(this, void 0, void 0, function () {
            var ethereum, _a, contractRegistry, HoneyProtocolAddress, converterRegistryAddress;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, contractRegistry.methods.addressOf(web3_1.default.utils.asciiToHex('HoneyProtocol')).call()];
                    case 2:
                        HoneyProtocolAddress = _b.sent();
            ...
            switch (_b.label) {
                case 0:
                    calls = amounts.map(function (amount) {
                        return paths.map(function (path) { return [ethereum.HoneyProtocol._address, ethereum.HoneyProtocol.methods.getReturnByPath(path, amount).encodeABI()]; });
